...
name: go-development
description: >-
  Covers idiomatic Go development including project structure, concurrency, error
  handling, and testing. Use when writing Go services, CLIs, or libraries. Not for
  database schema design (use database-design) or infrastructure orchestration (use
