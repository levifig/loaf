...
description: >-
  ...
  processing the intake queue (sparks + raw ideas), use triage instead.
  Not for deep exploration (use brainstorm) or shaping (use shape).
---
...
markdown file is created. The [idea template](templates/idea.md) is retained
