...
description: >-
  ...
  journals and brainstorm documents, plus raw ideas awaiting evaluation.
  Use when the user asks "what sparks do I have?", "review my ideas",
  "triage", or "what's in my backlog?" Produces promoted ideas, archived
  discards, and resolve(spark) journal entries.
  Not for capturing new ideas (use idea) or shaping (use shape).
---
