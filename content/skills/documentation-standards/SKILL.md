...
description: >-
  Covers API documentation, changelogs, documentation review, architecture formatting,
  and Mermaid diagrams. Use when documenting APIs, maintaining changelogs,
  reviewing document quality, checking a topic's presentation, or creating an
  architecture diagram. Not for architectural choices, current-model audits,
  or documentation migration (use architecture), inline code comments, or project READMEs.
---
