...
description: >-
  ...
  responsive patterns. Use when making design decisions, evaluating layouts,
  or ensuring accessibility compliance. Not for frontend code (use typescript-development)
  or API design (use architecture or language-specific skills).
---
