...
description: >-
  ...
  completing significant work or when the user asks "what did we learn?" Produces
  updates to VISION.md, STRATEGY.md, and ARCHITECTURE.md based on proven
  implementation. Not for pre-implementation strategy (use strategy) or architecture
  decisions (use architecture).
---
