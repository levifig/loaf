...
name: foundations
description: >-
  Covers code style, naming, TDD, verification, and code review standards.
  Use when writing or reviewing code, running checks, or setting up reviews.
  Not for git workflow, debugging, security, or documentation.
---
