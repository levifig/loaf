...
description: >-
  ...
  field, and the review workflow. Not for retrieval or search (use QMD directly),
  architectural models or rationale (use architecture), or agent instructions (use AGENTS.md).
---
