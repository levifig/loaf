...
| Start working on a task | the implement workflow ({{IMPLEMENT_CMD}}); `loaf task`/`loaf spec` stay transitional until the conversion pass — see the TRANSITIONAL note in CLAUDE.md |
