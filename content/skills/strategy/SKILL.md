...
description: >-
  ...
  interviews. Use when the user asks "what's our strategy?" or "update the strategic
  direction." Produces or updates STRATEGY.md with personas, market landscape, and
  problem space. Not for technical architecture (use architecture) or reflecting on
  shipped work (use reflect).
---
