...
description: >-
  ...
  stabilizing canonical vocabulary in the domain glossary as load-bearing
  terms surface. Use when making technical decisions or when the user asks
  "should we use X or Y?" Produces ADRs and updates ARCHITECTURE.md with
  technical constraints. Not for strategic direction (use strategy) or
  multi-perspective deliberation (use council).
---
