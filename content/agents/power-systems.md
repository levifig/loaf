...
- Web API implementation → implementer (with language skill)
- UI visualization → implementer (with typescript-development + interface-design)
- Database storage → implementer (with database-design)
