...
session:
  ...
  last_archived: "2025-12-04T16:00:00Z"        # Set by {{AGENT:context-archiver}} before compaction
...
background_agents:                             # Background work running independently
  - id: "bg-20260123-143000-security-scan"     # ID: bg-YYYYMMDD-HHMMSS-description
    agent: {{AGENT:background-runner}}                   # Agent type
...
<!-- Generated by {{AGENT:context-archiver}} before compaction -->
...
- [ ] Use `/loaf:cleanup` for auto-move + link updates after confirmation
...
- Outputs instructions for spawning {{AGENT:context-archiver}} agent
- {{AGENT:context-archiver}} updates sessions with:
