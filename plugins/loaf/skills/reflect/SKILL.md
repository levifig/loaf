...
description: >-
  ...
  completing significant work or the user asks "what did we learn?" Produces
  updates to VISION.md, STRATEGY.md, and ARCHITECTURE.md. Not for
  pre-implementation strategy or ADRs.
