...
4. If no `session:` field exists:
   ...
   This task hasn't been started yet. Use /loaf:implement TASK-XXX to begin work.
   ```
...
Usage:
  /loaf:resume TASK-001        # Resume by task ID
  /loaf:resume <session-file>  # Resume by session file
```
...
Usage:
  /loaf:resume TASK-001        # Resume by task ID
  /loaf:resume <session-file>  # Resume by session file
Example: /loaf:resume 20251215-115340-sdk-foundation
```
