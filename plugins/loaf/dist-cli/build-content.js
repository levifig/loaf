...
function loadAgentSidecar(sourcePath, target2) {
  const dir = dirname(sourcePath);
  const baseName = basename(sourcePath, ".md");
  const sidecarPath = join(dir, `${baseName}.${target2}.yaml`);
  if (!existsSync(sidecarPath)) {
    throw new Error(
      `Missing required sidecar: ${sidecarPath}
Agent '${baseName}' requires a sidecar for target '${target2}'`
    );
  }
  const content = readFileSync(sidecarPath, "utf-8");
  return (0, import_yaml.parse)(content);
}
function loadAgentSidecarOptional(sourcePath, target2) {
  const dir = dirname(sourcePath);
  const baseName = basename(sourcePath, ".md");
  const sidecarPath = join(dir, `${baseName}.${target2}.yaml`);
  if (!existsSync(sidecarPath)) {
...
function buildUnifiedPlugin(config, rootDir, srcDir, pluginsDir, targetsConfig) {
  ...
  cpSync3(fallbackSource, join7(pluginDir, "dist-cli"), { recursive: true });
...
function createPluginJson(config, pluginDir) {
  ...
  const hooksJsonDir = join7(pluginDir, "hooks");
  mkdirSync5(hooksJsonDir, { recursive: true });
  writeFileSync5(
    join7(hooksJsonDir, "hooks.json"),
...
function generateRuntimePlugin(config, srcDir, distDir, platform, version) {
...
function generateCode(config, platform, version) {
...
function generateCoreFunctions(platform) {
  return `// \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
// Core Hook Functions
// \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500
...
function generatePluginBody(config, platform) {
...
function generateOpenCodeSessionHandlers(config, platform) {
...
function generateAmpSessionHandlers(config, platform) {
  let handlers = "";
...
async function runBuild(options2 = {}) {
