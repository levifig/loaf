	...
	return []agentHelpCommand{
		...
		},
		{
			...
			Subcommands: []agentHelpSubcommand{
				...
				{Name: "show", Description: "Show one finding", Options: []agentHelpOption{{Flags: "--json", Description: "Output finding details, verdicts, relationships, global database scope, and project identity as JSON"}}},
