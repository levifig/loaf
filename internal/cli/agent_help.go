	...
	return []agentHelpCommand{
		...
		},
		{
			...
			Subcommands: []agentHelpSubcommand{
				...
				{Name: "repair relationship-origin", Description: "Backfill missing relationship provenance and reclassify retired legacy origins to 'command'; foreign origins are reported, never rewritten", Options: []agentHelpOption{{Flags: "--origin <imported|manual>", Description: "Provenance value to set on missing origins"}, {Flags: "--dry-run", Description: "Preview affected rows without writing"}, {Flags: "--apply", Description: "Apply the backfill and legacy reclassification after a backup"}, {Flags: "--json", Description: "Output repair plan/result, global database scope, and project identity as JSON"}}},
