...
const generatedPluginURL = process.env.LOAF_AMP_PLUGIN_PATH
  ? pathToFileURL(process.env.LOAF_AMP_PLUGIN_PATH).href
  : new URL('../../dist/amp/.amp/plugins/loaf.ts', import.meta.url).href;
