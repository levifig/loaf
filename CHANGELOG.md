...
- `/triage` shows a numbered candidate table and waits for an index pick before moving anything to Backlog; it does not call that move "publish" ([#237](https://github.com/levifig/loaf/issues/237)).
