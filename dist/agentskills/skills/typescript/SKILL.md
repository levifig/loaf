...
name: typescript
description: >-
  TypeScript and JavaScript development with React ecosystem. Covers project setup,
  ...
  Vitest/Playwright testing, and accessibility. Activate when working with .ts/.tsx/.js/.jsx
  files, package.json, or React/Next.js projects.
---
