...
After the wrap-up report, suggest housekeeping if it wasn't run this session and artifacts need attention. When sparks or open ideas need publishing or problem discovery, point at triage rather than treating explore or brainstorm as the next front-door workflow. Session-next may name an unblocked Todo item; wrap does not publish Issues or pick tomorrow's build from Backlog.

## Related Skills

- **triage** — process sparks and ideas captured this session (keep, archive, or publish as Backlog intent)
...
**What's Next**
- Run triage to process ideas (publish Backlog intent or hand problem-discovery items to pitch)
