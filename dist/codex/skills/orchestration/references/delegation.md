...
4. **Reference durable artifacts** - Task, spec, and report IDs; the separate Codex thread or explicit multi-agent tool when available's journal entries are harness-id tagged automatically
