...
Follows [foundations testing principles](../../foundations/reference/code-style.md#test-patterns). This reference covers Rails-specific tooling and conventions.
...
Mock external services and time; never mock your own models or database.
...
# Time-dependent behavior (Rails helper)
