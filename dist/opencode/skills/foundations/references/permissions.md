...
OpenCode uses permission prompts to protect against unintended actions. Configure permissions to reduce interruptions while maintaining appropriate safety.
