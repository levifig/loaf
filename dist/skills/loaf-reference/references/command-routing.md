...
| Start working on a task | the implement workflow (/implement); `loaf task`/`loaf spec` stay transitional until the conversion pass — see the TRANSITIONAL note in CLAUDE.md |
