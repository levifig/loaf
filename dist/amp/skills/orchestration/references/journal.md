...
- SessionStart emits the layered continuity digest; Amp check/agent mode or new thread invocations exit
...
| Pass a session alias to Amp check/agent mode or new thread | Nothing to pass — the harness id is automatic |
