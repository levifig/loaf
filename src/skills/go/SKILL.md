...
name: go
description: >-
  Use for all Go development. Covers idiomatic patterns from Effective Go, project structure,
  goroutines and channels for concurrency, explicit error handling, table-driven tests, and
  common idioms (guard clauses, defer, embedding). Activate when working with .go files,
  go.mod, or Go projects.
---
