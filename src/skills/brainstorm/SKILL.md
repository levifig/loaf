...
name: brainstorm
description: >-
  Conducts deep, structured brainstorming on ideas or problem spaces. Covers divergent
  thinking, problem decomposition, and creative exploration. Use when exploring possibilities
  before committing to a direction, or when the user asks "help me think through this" or
  "what are the options for...?" Produces structured idea explorations with trade-offs.
  Not for quick idea capture (use idea) or strategic direction (use strategy).
---
