...
description: >-
  Convenes multi-agent council deliberations for decisions requiring diverse perspectives.
  Use when the user asks "get a council opinion" or "I need multiple perspectives."
---
