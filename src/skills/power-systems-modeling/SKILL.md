...
description: >-
  Covers thermal rating models (CIGRE TB 601, IEEE 738), conductor temperature limits,
  catenary physics (sag, tension, clearance), electrical properties (resistance, reactance),
  and standards compliance (CIGRE, IEEE, IEC). Use when implementing thermal models, calculating
  conductor physics, or when the user asks "what are the CIGRE equations?" or "how do I validate
  this calculation?"
---
