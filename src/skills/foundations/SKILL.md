...
description: >-
  ...
  the security best practice for X?" Produces validated commits, formatted documentation, and
  security-reviewed code. Not for language-specific patterns, framework APIs, or deployment
  (use language skills).
---
