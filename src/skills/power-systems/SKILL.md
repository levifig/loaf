...
name: power-systems
description: >-
  Use for electrical power systems engineering. Covers thermal rating models (CIGRE TB 601,
  IEEE 738), conductor temperature limits, catenary physics (sag, tension, clearance),
  electrical properties (resistance, reactance), and standards compliance (CIGRE, IEEE, IEC).
  Activate when working with transmission line calculations, thermal modeling, or conductor
  physics validation.
---
