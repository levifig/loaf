...
description: >-
  ...
  I break down this work?" or "which agent should handle this?" Produces session files, council
  records, task breakdowns, and progress updates. Not for standalone research, brainstorming, or
  vision work (use research).
---
