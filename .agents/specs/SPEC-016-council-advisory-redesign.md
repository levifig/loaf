...
- [ ] Should the convergence summary be generated by a separate agent or by the orchestrating Claude?
- [ ] How should the skill reference existing Loaf skills for specialist backing — by name, by domain keyword, or by a mapping table?
