...
- **Remaining boundary:** U7 normalized envelopes, outcome-aware trusted seams, namespaced origins, lifecycle suppression, safe-hook preflight, and replay evidence are implemented; real target adapters and automatic capture remain unsupported until U8 proves trusted target-native adapters, visible warning/context routing, and installed runtime behavior. U9 retains ownership of content-addressed install convergence, documentation reconciliation, and cross-harness dogfood.
