...
| [task-system.md](task-system.md) | tasks, specs, shape-up, sessions | `.agents/specs/**/*.md`, `.agents/tasks/**/*.md`, `.agents/sessions/**/*.md`, `internal/cli/cli.go`, `internal/state/task_*.go` |
