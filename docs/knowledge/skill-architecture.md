...
35 skills total: 19 workflow/default-invocable, 16 non-invocable with `user-invocable: false` (reference/knowledge skills plus the brainstorm technique consumed by explore).
