...
The next implementation commit should continue the completion-audit pass by auditing human output and JSON failures for backup/export/import command surfaces against the reliability contract, then tighten the first remaining mismatch between docs, tests, and dogfood evidence.
