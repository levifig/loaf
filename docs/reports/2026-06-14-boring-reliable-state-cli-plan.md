...
The next implementation commit should continue the completion-audit pass by auditing backup/export/import command output against the full reliability contract, then tighten the first remaining mismatch between the contract, docs, tests, and dogfood evidence.
