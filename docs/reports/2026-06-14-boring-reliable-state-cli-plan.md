...
The next implementation commit should dogfood `state export all`, `state export triage`, and the markdown report export surfaces in human and failure modes, then normalize the first inconsistent high-risk output or next-action gap it finds.
