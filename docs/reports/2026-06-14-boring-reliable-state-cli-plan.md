...
The next implementation commit should continue the dogfood human-output matrix across the backup command family, especially backup creation syntax/help and whether creation output needs next-action guidance comparable to backup verification.
