...
The next implementation commit should continue the completion-audit pass by auditing remaining `--agent-help` raw JSON descriptions for KB/check/housekeeping/trace and entity families such as brainstorm, idea, spark, tag, bundle, and link.
