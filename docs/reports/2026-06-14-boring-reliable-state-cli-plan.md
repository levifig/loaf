...
The next implementation commit should run a final terminal-help sweep for remaining generic `Output JSON` wording outside agent help and generated CLI reference output.
